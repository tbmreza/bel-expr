...
main = defaultMain $ testGroup "Tests"
  ...
  -- [ testGroup "Properties" [ testProperty "mapEval doesn't crash" propMapEval
  --                          ]
  -- ]
...
e2eRender :: TestTree
e2eRender = testCase "render template parts" $ do
...
propMapEval :: String -> Property
propMapEval input = ioProperty $ do
    pure True
